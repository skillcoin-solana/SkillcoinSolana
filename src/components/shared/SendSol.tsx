...
const SendSol = () => {
	...
	return (
		<div className="explore-container">
			...
			<div className="flex flex-wrap w-full max-w-5xl mt-8">
				<div className="flex flex-col w-full gap-4">
					<div className="flex flex-col">
						...
						<input
							...
							className="w-1/2 h-10 p-2 bg-gray-2 border-none placeholder:text-gray-5 focus-visible:ring-1 focus-visible:ring-offset-1 ring-offset-denim-blue"
						/>
					</div>
					<div className="flex flex-col">
					...
					<div className="text-sm font-montserrat mt-8 bg-gray-2 rounded-lg p-2 w-1/2">
						<ul className="p-2">
